...
$table_dbs=mysql_query("SELECT * FROM student_temp_db WHERE course_id='Pre-Nus' ");
while ($explode_array=mysql_fetch_array($table_dbs))
{
       ...
       $class_db=mysql_query("SELECT * FROM course_db WHERE course_name='NUS'");
...
$enrollment_no="";
 ...
 $session_id=$fecth_session_id_set;
    ...
    $student_dob=$explode_array['student_dob'];;
    $student_blood_group="";
    $student_birth_place=$birth_place;
    $student_nationality="Indian";
    $student_religion=$religino;
    $student_mother_tongue="Hindi";
    $student_category=$category;
    $student_sub_category=$subcategory;
    ...
    $student_current_address=$explode_array['current_address'];
    $student_current_nearest_area=$explode_array['current_nearest_area'];
    $student_current_city=$explode_array['current_city'];
    $student_current_desctric=$explode_array['current_desctric'];
    $student_current_post="Bilaspur";
    $student_current_pincode=$explode_array['current_pincode'];
    $student_current_state=$explode_array['current_state'];
    $student_current_country=$explode_array['current_country'];
    
    $student_per_address=$explode_array['permanent_address'];
    $student_per_nearest_area=$explode_array['permanent_nearest_area'];
    $student_per_city=$explode_array['permanent_city'];
    $student_per_desctric=$explode_array['permanent_desctric'];
    $student_per_post="Bilaspur";
    $student_per_pincode=$explode_array['permanent_pincode'];
    $student_per_state=$explode_array['permanent_state'];
    $student_per_country=$explode_array['permanent_country'];
    
    
    //father insert valute
    
    $student_father_name=$explode_array['father_name'];
    $student_father_mobile_no=$explode_array['father_mobile_no'];
    $student_father_email_id=$explode_array['father_email'];
    $student_father_qualification=$explode_array['father_qualification'];
    $student_father_occupation=$explode_array['father_occupation'];
    $student_father_annual_income=$explode_array['father_annual_income'];
    $student_father_photo=$explode_array['father_photo'];
    
    $student_mother_name=$explode_array['mother_name'];
    $student_mother_mobile_no=$explode_array['mother_mobile_no'];
    $student_mother_email_id=$explode_array['mother_email_id'];
    $student_mother_qualification=$explode_array['mother_qualification'];
    $student_mother_occupation=$explode_array['mother_occupation'];
    $student_mother_annual_income=$explode_array['mother_annual_income'];
    $student_mother_photo=$explode_array['mother_photo'];
    
    
    $student_guardian_relation=$explode_array['local_parent_relation'];;
    $student_guardian_name=$explode_array['local_parent_name'];
    $student_guardian_mobile_no=$explode_array['local_parent_mobile_no'];
    ...
    $student_previous_class=$explode_array['previous_class_name'];
    $student_core_subject=$explode_array['previous_class_core_subject'];
    $student_board_university=$explode_array['previous_class_board'];
    $student_passing_year=$explode_array['previous_class_passing_year'];
    $student_per_of_marks=$explode_array['previous_class_per_of_mark'];
    $student_extra_activities="";
    $student_school_name=$explode_array['previous_class_school_name'];
    $student_school_address=$explode_array['previous_class_school_address'];
