...
$house_name=ucwords($fetch_student_data['house_name']);
    ...
    <a border='0' href='registration.php'>
       <div class='button_style' style='background-color:orange;'> Finish</div></a>";
    {
        ?>
       <a href="#" onclick="window.open('addmision_form_print.php?token_id=<?php  echo $admission_encrypt_id;?>','size',config='height=700,width=1050,position=absolute,left=100,top=0, addressbar=yes, location=no, toolbar=no, menubar=no,copyhistory=no, scrollbars=yes, resizable=yes, directories=no, status=no')">
                        
       <div class='button_style'>Print</div></a>
       <a border='0' href='edit_student_detail.php?token_id=<?php  echo $admission_encrypt_id?>'>
              ...
              if((!empty($student_hostel_data))&&($student_hostel_data!=null)&&($student_hostel_num_rows!=0))
              {
                  ...
                  $hostel_type="";    
                   ...
                   $student_allot_transport_db=mysql_query("SELECT *,TB1.description as transport_description FROM student_allot_transport as TB1 "
                    ...
                    <tr>
                        <td colspan='9'><input type='checkbox' checked >
...
{
    window.open('addmision_form_print.php?token_id=<?php  echo $admission_encrypt_id;?>','size',config='height=700,width=1050,position=absolute,left=100,top=0, addressbar=yes, location=no, toolbar=no, menubar=no,copyhistory=no, scrollbars=yes, resizable=yes, directories=no, status=no');
}    
    </script> 
