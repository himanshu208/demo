...
<html>
    ...
    <body onload="window_print()">
        <div id='print_admission_form'>
        <div id='middle_center_admission_from_print'>
...
$house_name=ucwords($fetch_student_data['house_name']);
    ...
    if((!empty($student_local_parent_relation))&&(!empty($student_local_parent_name))||((!empty($student_previous_class))&&(!empty($student_board_university)))
        ||(!empty($implode_document_attechment))||(!empty($library_account_status))||((!empty($student_hostel_id))&&(!empty($student_hostel_type_id)))
        ||(!empty($student_transport_route_id))&&(!empty($student_transport_vehicle_type_id)))
{
    echo "<style> #page{ page-break-before: always; } </style>";
}  else {
        ...
        echo "    
                ...
                <table cellspacing='0' cellpadding='0' class='top_school_report_image'>
                    <tr>
                        <td><img border='0'  class='school_admission_image' src='../$fetch_branch_report_logo'></td>
                    </tr>
                </table>     
                <table cellspacing='0' cellpadding='0' class='admission_form_tables'>
                   
                    <tr>
                        <td colspan='9'><div class='heading_title'>ADMISSION FORM</div></td>
                    </tr>
                    ...
                    <td></td><td></td>
                    <td rowspan='9' >
                    <img class='student_image' src='../$student_father_photo'></td>
                    </tr>
           ...
           $student_hostel_num_rows=mysql_num_rows($student_hostel_db);
              if((!empty($student_hostel_data))&&($student_hostel_data!=null)&&($student_hostel_num_rows!=0))
              {
                ...
                if((!empty($transport_id)))
                   ...
                   $student_allot_transport_db=mysql_query("SELECT *,TB1.description as transport_description FROM student_allot_transport as TB1 "
                    ...
                    if((!empty($transport_data))&&($transport_data!=null)&&($transport_num_rows!=0))   
                    {
                     ...
                     $description=$transport_data['transport_description'];
...
echo "</table></div>";
                    ...
                    echo"<table cellspacing='0' cellpadding='0' class='admission_form_tables' ><tr>
                        <td><div class='height_maintain'></div></td>
                    </tr>
                    <tr>
                        <td><div class='height_maintain'></div></td>
                    ...
                    <tr>
                        <td colspan='9'>
                            <b> I hereby certify that information provided above is true and to the best to my knowledge and belief . If any information found to be false/incorrect it will disqualify my continuation in school/collage
                            </b></td>
                    </tr>
                    ...
                    <tr>
                        <td colspan='7' style='text-align: right; '><b>Admission Date</b></td><td><b>:</b></td>
                    ...
                    <tr>
                        <td style=' text-align:center; ' colspan='3'><B>Admission Coordinator Signature</B></td>
                    <td style=' text-align:center; ' colspan='3'><B>Parents/Guardian Signature</B></td>
                 <td style=' text-align:center; ' colspan='3'><B>Student Signature</B></td>
                ...
                <table cellspacing='0' cellpadding='0' class='admission_form_tables' >
                    ...
                    <tbody><tr>
                        <td colspan='9'><div class='heading_title'>ADMISSION RECEIPT </div></td>
                    </tr>
                   ...
                   <td><b>Handicapped</b></td><td><b>:</b></td><td> $studnet_handicapped</td>
                    ...
                    $route_db=  mysql_query("SELECT * FROM  transport_route_db WHERE organization_id='$fetch_school_id'
                     and branch_id='$fetch_branch_id' and session_id='$fecth_session_id_set' and route_id='$student_transport_route_id'");    
                   ...
                   $vehicle_type_db= mysql_query("SELECT * FROM  transport_vehicle_type_db WHERE organization_id='$fetch_school_id'
                     and branch_id='$fetch_branch_id' and session_id='$fecth_session_id_set' and vehicle_type_id='$student_transport_vehicle_type_id'");    
                   ...
                   $fetch_vehicle_db=mysql_query("SELECT * FROM transport_vehicle_db WHERE organization_id='$fetch_school_id'
                     and branch_id='$fetch_branch_id' and session_id='$fecth_session_id_set' and vehicle_id='$student_transport_vehicle_reg_no'");
