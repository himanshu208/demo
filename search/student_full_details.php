...
<html>
    ...
    <body>
          <div id='print_admission_form'>
              <div id='middle_center_admission_from_print' style=" font-size:12px; ">
        ...
        if((!empty($_REQUEST['token_id'])))
        {
         ...
         $student_db=mysql_query("SELECT *,T1.id as db_id,T1.encrypt_id as encrpt_id,T1.user_name as student_user_name"
                 ...
                 . " T1.encrypt_id='$admission_encrypt_id' and T1.is_delete='none'");
