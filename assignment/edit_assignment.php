...
$final_assign_id=$_POST['update_unique_id']; 
            ...
            {
         $select_check_db=  mysql_query("SELECT * FROM assignment_db WHERE $db_main_details assignment_id!='$final_assign_id' and title='$title' and "
        ...
        $update_db=mysql_query("UPDATE assignment_db SET title='$title',description='$description',"
                . "date_of_submit='$date_of_submission',class_id='$class',section_id='$section',subject_id='$subject' "
                . "WHERE assignment_id='$final_assign_id' and is_delete='none'");
        
        
        if($update_db)
        {
            
        $delete_db=mysql_query("DELETE FROM assignment_attech_file_db WHERE assignment_id='$final_assign_id'");    
       ...
       <form action="" method="post" name="form1" onsubmit="return validate_form();" enctype="multipart/form-data">
        ...
        <div class="edit_first_div">
            <div class="edit_top_header">
                <div class="title_name">Edit Assignment Details</div>   
            ...
            $select_data=mysql_query("SELECT * FROM assignment_db WHERE encrypt_id='$token_id' and is_delete='none'"); 
            ...
            if((!empty($fetch_db_data))&&($fetch_db_data!=null)&&($fetch_num_data!=0))
            {
             ...
             {
             ?>  
              <input type="hidden" id="update_unique_id" name="update_unique_id" value="<?php echo $assignment_id;?>">
                   ...
                   <table cellspacing="3" cellpadding="3" class="insert_table">
                       ...
                       <tr>
                          ...
                          <td> <input type="text" name="assignment_title" placeholder='Please enter assignment title'
                                      id="assignment_title"  value="<?php echo $title;?>" class="text_box_styles"  autocomplete="off"> </td>
                          <td>
                          </td>
                      </tr>
                       ...
                       <tr>
                          ...
                          <td colspan="2">
                              <textarea name="assignment_description" placeholder='Please enter assignment description'
                                        id="assignment_description" class="text_area_styles" style=" width:450px; "><?php echo $description;?></textarea>   
                          </td>
                      </tr>
                       <tr>
                          <td><b>Date of Submission <sup>*</sup> </b></td><td><b>:</b></td>
                          <td> <input type="text" name="submit_date"  id="submit_date" 
                                      class="text_box_styles" value="<?php echo $date_of_submit;?>" autocomplete="off"> 
                             </td>
                      </tr>
                       <tr>
