...
$result=mysql_query("SHOW TABLE STATUS LIKE 'notes_db'");
$row=mysql_fetch_array($result);
$nextId=$row['Auto_increment']; 
$final_assign_id="NOTS_$nextId"; 
$encrypt_id=md5(md5($final_assign_id));
            ...
            {
         $select_check_db=  mysql_query("SELECT * FROM notes_db WHERE $db_main_details title='$title' and "
        ...
        $insert_db=mysql_query("INSERT into notes_db values('','$fetch_school_id','$fetch_branch_id','$insert_session_id'"
                . ",'$final_assign_id','$encrypt_id','$title','$description','$class'"
       ...
       <?php  include_once '../header/header_page.php'; ?>   
        ...
        <div id="main_work_first_div">
            <div id="middel_work_div">
                <div class="forward_step_style" style=" float:left; height:40px;  ">
                   <table cellspacing="0" cellpadding="0" class="forward_page_style">
                       <tr>
                           ...
                           <td>/</td>
                           <td><a href="list_of_assigment.php">List of Notes</a></td>
                           <td>/</td>
                           <td>Add Notes</td>
              ...
              <div id="transport_function" class="Short_menu_show"><b>Add Notes</b></div>
             
              <a href="list_of_notes.php"> <div class="view_button"  style=" margin-right:10px; background-color:dodgerblue;  ">List Of Notes</div> </a> 
                   </div>
               ...
               ?>
                   <table cellspacing="3" cellpadding="3" class="insert_table">
                       ...
                       <tr>
                          ...
                          <td> <input type="text" name="notes_title" placeholder='Please enter note title'
                                      id="notes_title"  class="text_box_styles"  autocomplete="off"> </td>
                          <td>
                          </td>
                      </tr>
                       ...
                       <tr>
                          ...
                          <td colspan="2">
                              <textarea name="notes_description" placeholder='Please enter note description'
                                        id="notes_description" class="text_area_styles" style=" width:450px; "></textarea>   
                          </td>
                      </tr>
                       <tr>
