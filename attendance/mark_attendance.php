...
$results=mysql_query("SHOW TABLE STATUS LIKE 'attendance_mark_db'");
$rows=mysql_fetch_array($results);
$nextIds=$rows['Auto_increment']; 
$attendance_day_id="T_DY_$nextIds";
$encrypt_ids=md5($attendance_day_id);
    
  $insert_attendance_day=mysql_query("INSERT into attendance_total_day_db values('','$fetch_school_id','$fetch_branch_unique_db_id'"
        . ",'$insert_session_id','$attendance_day_id','$encrypt_ids'"
          . ",'$insert_course_id','$insert_section_id','$insert_attendance_date','$note','none','$today_date','$date_time')");   
  if((!empty($insert_attendance_day))&&($insert_attendance_day))  
  {
...
$result=mysql_query("SHOW TABLE STATUS LIKE 'attendance_mark_db'");
$row=mysql_fetch_array($result);
$nextId=$row['Auto_increment']; 
$final_student_fee_pay_fee_id="M_ATTE_$nextId";
$encrypt_id=md5($final_student_fee_pay_fee_id);

$insert_attendance=mysql_query("INSERT into attendance_mark_db values('','$fetch_school_id','$fetch_branch_unique_db_id'"
        . ",'$insert_session_id','$final_student_fee_pay_fee_id','$encrypt_id','$insert_attendance_date','$insert_course_id','$insert_section_id'"
        . ",'$insert_student_id','$attendance_day_id','','$attendance','$remark','none','$fecth_user_unique','$today_date','$date_time','','action')");
 }
    ...
    echo "<option>--- Select ---</option>";      
                          ...
                          $get_date="";      
                           ...
                           <td><input readonly="readonly" type="text" id="attendance_date" class="text_box_styling" 
                             ...
                             <td style=" width:20px; "></td>
<td><input type='button' class='add_button_reset_button' onclick="continue_button()" value='Continue'></td>
...
$total_working_days=mysql_num_rows($total_work_day);  
                 ...
                 . " $db_t1_main_details T1.course_id='$class_id' and T1.section_id='$section_id' and T1.is_delete='none' ORDER BY T1.admission_no ASC");
                   ...
                   ?>      
                       ...
                       <div class="attendance_month_register">
                         ...
                         <?php 
                           ...
                           <div class='button_viem_month' onclick="attendance_delete('')"
                   ...
                   {   
                       ...
                       <td class="attendance_td_style"><?php  echo $fetch_student_father_name;?></td>
                                   ...
                                   <center>
                                     ...
                                     <table cellspacing='0' cellpadding='0'>
                                         <tr>
                                             <td> <input name="mark_attendance_<?php  echo $fetch_student_id;?>" onclick="prsent_status('<?php  echo $fetch_student_id;?>')" class='td_attendance_check_box_p' type='radio' value='p' checked></td>
                                 ...
                                 <td class="attendance_td_style">
                                   <center>
                                     ...
                                     <table cellspacing='0' cellpadding='0'>
                                         <tr>
     <td>
     <input name="mark_attendance_<?php  echo $fetch_student_id;?>" onclick="absent_status('<?php  echo $fetch_student_id;?>')" class='td_attendance_check_box_a' type='radio' value='a'></td>
     </td>
                                             <td>Absent</td>
                                         </tr>
                                     </table>
                                 ...
                                 <td class="attendance_td_style">
                                   <center>
                                     ...
                                     <table cellspacing='0' cellpadding='0'>
                                         <tr>
                                             <td>
        <input name="mark_attendance_<?php  echo $fetch_student_id;?>" onclick="leave_status('<?php  echo $fetch_student_id;?>')" class='td_attendance_check_box_l' type='radio' value='l'></td>
                                 ...
                                 <td class="attendance_td_style">
                                   <center>
                                     ...
                                     <table cellspacing='0' cellpadding='0'>
                                         <tr>
                                             <td>
  <input name="mark_attendance_<?php  echo $fetch_student_id;?>" onclick="school_leave_status('<?php  echo $fetch_student_id;?>')" class='td_attendance_check_box_lt' type='radio' value='lt'></td>
                                 ...
                                 <td class="attendance_td_style" style=" padding-left:3px; padding-right:3px;  ">
                                     ...
                                     <textarea id="remark_<?php  echo $fetch_student_id;?>" style=" width:96%; " name="remark_<?php  echo $fetch_student_id;?>"></textarea>
                                     <?php
                                      }else
                                      {
                                      echo $remark;    
                                                       ...
                                                       if((empty($attendance_total_data))&&($attendance_total_data==null)&&($attendance_total_num_rows==0))
{
                           ...
                           ?>
                                     ...
                                     <input type="button" class="button_styling" onclick="on_submit_button()" id="submit_button_1" name='save_attendance_button' value="Save"> 
