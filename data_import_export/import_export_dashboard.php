            ...
            <div id="middel_work_div">
               ...
               value="<?php  echo $fecth_session_id_set;?>">   
                ...
                <div id="top_show_button" style=" border-bottom:1px solid gray; ">
                    <div id="transport_function" class="Short_menu_show"><b>Data Import/Export</b></div>
                </div>
                 ...
                 <table class="small_short_table">
                     <tr>
                      ...
                      <tr>
                        ...
                        <tr>
                            <td><span>Student/Employee Data Export</span></td>
                        </tr>
                 </table>
                </div> 
               </a>
                  
                  <a href="data_import.php">
                 <div class="small_dashboard">
                 ...
                 <table class="small_short_table">
                     <tr>
                      ...
                      <tr>
                        ...
                        <tr>
                            <td><span>Student/Employee Data Import</span></td>
                        </tr>
                 </table>
                </div> 
               </a>
