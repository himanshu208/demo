...
$result=mysql_query("SHOW TABLE STATUS LIKE 'transport_driver_db'");
$row=mysql_fetch_array($result);
$nextId=$row['Auto_increment']; 
$final_driver_id="DRIVER_$nextId"; 
$encrypt_id=md5(md5($final_driver_id));
...
if((empty($fecth_data))&&($fecth_data==null)&&($fecth_num_rows==0))
{
  $b=1;
    ...
    if(!empty($b))
    {
        if(!empty($c))
        {
        $insert_db=mysql_query("INSERT into transport_driver_db values('','$fetch_school_id','$fetch_branch_id','$insert_session_id'"
         . ",'$final_driver_id','$encrypt_id','$is_employee','$employee_id','$first_name','$gender','$dob','$father_name','$mobile_no'"
         . ",'$email','$married_status','$address','$license_no','$lisence_expire_date','$location1','$location','$description','none','$date','$date_time'"
            ...
            <div id="middel_work_div">
               ...
               value="<?php  echo $fecth_session_id_set;?>">   
                ...
                <div id="top_show_button" style=" border-bottom:1px solid gray; ">
                    <div id="transport_function" class="Short_menu_show"><b>Add Driver</b></div>
                    <a href="view_driver_details.php">
                        <div class="view_button">View Driver Details</div></a>
                </div>
               ...
               <div class="middle_left_div_tag">
                       ...
                       <tr>
                           <td colspan="3">
                               <table style="width:270px;   margin: 0 auto; border:1px solid whitesmoke; background-color:whitesmoke;
                                   ...
                                   <tr>
                                       <td><input name="is_employee" value="no" onclick="check_radio('new_driver')" type="radio" checked></td><td><b>New Driver</b></td>
                   ...
                   <table cellsapcing="4" cellpadding="4" class="table_middle" style=" font-size:12px; ">
                       ...
                       <td><b>:</b></td>
                       <td><input type="text" id="first_name" name="first_name" placeholder="Please enter driver name" class="text_box_class"></td>
                       </tr>
                       ...
                       <td><b>:</b></td>
                       <td><input type="text" id="mobile_number" name="mobile_number" placeholder="Please enter driver mobile number" class="text_box_class"></td>
                       </tr>
                       ...
                       <td><b>:</b></td>
                       <td><input type="text" id="license_no" name="license_no" placeholder="Please enter Driving license number" class="text_box_class"></td>
                       </tr>
                         <tr>
                             <td>License Expire Date <sup>*</sup></td>
                       <td><b>:</b></td>
                       <td><input type="text" id="license_expire_date" name="license_expire_date" placeholder="Please enter license number" class="text_box_class"></td>
                       </tr>
                       <tr>
                             <td>Document</td>
                       <td><b>:</b></td>
