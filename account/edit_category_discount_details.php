...
$discount=$_POST['nameofdiscount'];
$discount_description=$_POST['description'];
$update_db_id=$_POST['update_db_id'];
$session_id=$_POST['use_inset_session_id'];
    
$update_discount_category_db=mysql_query("UPDATE financefeediscountcategory SET discount_type='$discount_type',feediscount='$discount',feediscountdescription='$discount_description'"
  ...
  {       
   ...
   #financefirstdiv{ width:100%;height:100%;  margin:0; padding:0;  
    ...
    #error-msg{ width:600px; height:20px;padding-top:3px; background-color:#FFFFCC; 
                ...
                background-image:url('finanacephoto/skyblue.pg'); border:1px solid silver;  font-size: 12px;   }
    ...
    <body style="margin: 0; padding:0; ">
      ...
      <?php  include_once 'edit_header_page.php';?>
        ...
        <div class="first_work_div">
            <div class="edit_title_heading">Edit Category Discount Details</div>
          <?php 
            
            if(!empty($_REQUEST['token_id']))
            {
             $encrypt_id=$_REQUEST['token_id'];
             $discount_category_db=mysql_query("SELECT * FROM financefeediscountcategory WHERE organization_id='$fetch_school_id' and branch_id='$fetch_branch_unique_db_id' and session_id='$fecth_session_id_set' and encrypt_id='$encrypt_id' and action='active'");
          $fetch_discount_category_data=mysql_fetch_array($discount_category_db);
          $fetch_discount_category_num_rows=mysql_num_rows($discount_category_db);
          if((!empty($fetch_discount_category_data))&&($fetch_discount_category_data!=null)&&($fetch_discount_category_num_rows!=0))
          {
           $fetch_db_id=$fetch_discount_category_data['id'];
           $fetch_course_id=$fetch_discount_category_data['course_id'];
           $fetch_fee_group_id=$fetch_discount_category_data['fee_group_id'];
           $fetch_category_id=$fetch_discount_category_data['category_id'];
           $discount_type=$fetch_discount_category_data['discount_type'];
           $discount=$fetch_discount_category_data['feediscount'];
           $discount_description=$fetch_discount_category_data['feediscountdescription'];
           
           //category
            $select_category_db=mysql_query("SELECT * FROM category_db WHERE organization_id='$fetch_school_id'
                     and branch_id='$fetch_branch_id' and category_id='$fetch_category_id'");
             $fetch_category_data=  mysql_fetch_array($select_category_db);
             $fetch_category_num_rows=  mysql_num_rows($select_category_db);
             if((!empty($fetch_category_data))&&($fetch_category_data!=null)&&($fetch_category_num_rows!=0))
             {
               ...
               $fetch_category_name="Missing Record";  
             }
           ...
           //fee group
                       $fee_group_db=mysql_query("SELECT * FROM financeaddfeegroup WHERE organization_id='$fetch_school_id' and branch_id='$fetch_branch_id' and session_id='$fecth_session_id_set' and fee_group_id='$fetch_fee_group_id'");
                            ...
                            {
                             $course_name="Missing Record";   
                            }
           
           {
            ?>
        
            <table  cellspacing="0" cellpadding="0" id="table_midle_set" style=" font-weight: 100;">
                               ...
                               <tr>
                                     ...
                                     <td colspan="2" class="td_leftpadding">
                                      ...
                                      <table  cellspacing="0" cellpadding="0" id="table_midle_settable">
                                          <tr>
                                              ...
                                              <td><strong>:</strong></td>
                                              <td>
                                                  <input type="hidden" name="update_db_id" value="<?php  echo $fetch_db_id;?>">
                                                  <select onchange="class_id_change(this.value)" id="category_clsss_id" class="select_box" disabled>
                                     ...
                                     <td colspan="2" class="td_leftpadding">
                                      ...
                                      <table  cellspacing="0" cellpadding="0" id="table_midle_settable">
                                          <tr>
                                              ...
                                              <td>
                                                  <select id="categoryname" class="select_box" name="nameofcategory" disabled>
                                                   <option><?php  echo $fetch_category_name;?></option>
                                               </select>
                                              </td>
                                          ...
                                          <tr>
                                              ...
                                              <td>
                                               <input type="text" id="discount" 
                                                      value="<?php  echo $discount;?>"   class="text_sizebox" name="nameofdiscount" style=" width:290px; height:25px;  ">
                                              </td>
                                          </tr>
                                          <tr>
                                              <td width="45px;">
                                              ...
                                              <td>
                                               <textarea id="textareasize" name="description" class="text_sizebox"
                                                         style=" width:290px;  height:60px;"><?php  echo $discount_description;?></textarea>
                                              </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                         <input type="submit" value="Update" id="categorysavebutton" name="addfeedetails" 
