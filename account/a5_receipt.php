...
$student_pay_fee_id=$fetch_fee_payment_data['student_pay_fee_id'];
          ...
          echo "<div class='first_reciept_div' style='margin-top:10px;'>
...
<tr>
<td style='width:130px;'> <img height='80px' src='../$school_logo'></td>
<td><center>$school_name</center><br/> <center>$school_address</center></td>    
          ...
          <tr>
            ...
            <tr>
                <td COLSPAN='6' class='fee_recipt_title_name' style='text-align:center; font-size:18px; '><b>Fee Receipt</b></td>
            </tr>
            <tr>
                <td COLSPAN='6'><div class='horizental_line_black'></div></td>
            </tr>
...
<table style='width:100%;'>
         ...
         <tr>
              <td style=' font-size:13px; '><b>Amount Payable</b></td>
                ...
                <td  style=' font-size:15px; '><b>Amount Paid</b></td>
                <td><b>:</b></td>
                <td style='font-size:15px;'><b>$fetch_currency $amount_paid/-</b></td>
...
<tr>
<td colspan='6'>
<table cellspacing=0; style='width:45%; margin-top:10px; float:left; border:1px solid black;'>
<tr><td COLSPAN='6' class='fee_recipt_title_name' style='font-size:14px; padding-left:10px;'><b>Payment Details</b></td></tr>
  <tr><td COLSPAN='6'><div class='horizental_line_silver'></div></td></tr> 
<tr>
...
<table cellspacing=0; style='width:45%; margin-top:10px; float:right;border:1px solid black;'>
<tr><td COLSPAN='6' class='fee_recipt_title_name' style='font-size:14px; padding-left:10px;'><b>Fee Description</b></td></tr>
  <tr><td COLSPAN='6'><div class='horizental_line_silver'></div></td></tr> 
<tr>
<td colspan='6' style='padding-top:5px; padding-left:10px; padding-bottom:5px;'></td>
</tr>
</table>
          ...
          ";
           ...
           echo" 
            ...
            <tr>
                <td colspan='6' style='font-size:11px;'>WE THANKFULLY ACKNOWLEDGE THE RECEIPT OF $fetch_currency $amount_paid/-
                <br/>
            ...
            <tr>
                ...
                <td colspan='3' style='text-align:right;''><b>Signature Of Depositor</b></td>
