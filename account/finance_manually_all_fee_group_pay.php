...
function dmyTimed($dtd)
{
    ...
    $student_db=mysql_query("SELECT *,T1.encrypt_id as t1_encrypt_id FROM student_db as T1 "
    ...
    $course_id=$class_id;
    $student_encrypt_id=$student_data['t1_encrypt_id'];
    ...
    
    {
     ?>
        <style>
            .view_list_button{ width:auto; height:auto; background-color:darkblue;
             padding:0.4em; color:white; float:right; margin-bottom:4px; cursor:pointer;     }
            </style>
     ...
     <input type='button' class='view_list_button' value='Due Fees Slip Print'></a>
         ...
         <input type="text" style="width:35px; color:gray; background-color:yellow; border:1px solid silver;
                text-align: center;"  name="fee_group_qty[]" id="due_qty_<?php echo $fetch_due_amount_fee_id;?>" readonly="readonly" value="1"></td>
                          ...
                          <td class="td_print_value" style=" text-align:left; font-size:10px; text-indent:2px;   ">
                              ...
                              <a style="color:blue;" href="#" onclick="window.open('finance_fee_view_details.php?token_id=<?php echo $fee_encrypt_id;?>','size',config='height=530,width=900,position=absolute,left=300,top=0, addressbar=yes, location=no, toolbar=no, menubar=no,copyhistory=no, scrollbars=yes, resizable=yes, directories=no, status=no')">
        ...
        <option>Other Bank</option>
             ...
             <tr>
               ...
               <?php 
                 ...
                 <td style=" height:30px; background-color: aqua;  ">
                     <input type="text" name="due_amount" readonly="readonly" id="due_amount"
                            style=" background-color:yellow; height:22px; padding-left:7px; width:90px;   border:1px solid black;   " value="<?php  echo $due_amount_value;?>"></td>
