        ...
        <input id="company_logo_link" type="hidden" value="<?php  echo $fetch_school_logo;?>">
         ...
         <table cellspacing="0" cellpadding="0"  id="fullviewtable">
               ...
               value="<?php  echo $fecth_session_id_set;?>">  
                        <style>
                         #color_5{ background-color:dodgerblue; color:white; border-top-left-radius:3px;
...
$("#date_to").datepicker({ 
  ...
  <abbr title="Fee Payment">
            ...
            <td>
             ...
             ul{ list-style:none; float:left; margin-left:0;  }
             ul li { padding-top:5px; padding-bottom:5px; margin-left: 0;  }
             ...
             $section_num_rows=  mysql_num_rows($section_db);
                ...
                if($payment_ststus=="CANCEL")
                {
                  ...
                  echo "<tr><td class='td_heading_data'>$row</td>"
                          ...
                          . "<td class='td_heading_data' id='print_view'>";
                  {
                ?>
              ...
              <?php 
                  ...
                  echo"</td>"
                          . "<td class='td_heading_data' id='print_view' style='border-right:1px solid black;'>";
                  {
                         ?>   
                        
                         <a style="color:blue;" href="#" onclick="window.open('finance_fee_view_details.php?token_id=<?php  echo $encrypt_id;?>','size',config='height=670,width=900,position=absolute,left=10,top=0, addressbar=yes, location=no, toolbar=no, menubar=no,copyhistory=no, scrollbars=yes, resizable=yes, directories=no, status=no')">  
