 ...
 function makeLogRand() {
  ...
  return $sign * (int) ($val * pow(10.0, $scale));
            ...
            $student_db=mysql_query("SELECT *,T1.id as db_id,T1.encrypt_id as encrpt_id,T1.user_name as student_user_name"
                 ...
                 . " $db_t1_main_details T1.encrypt_id='$student_encrypt_id' and T1.is_delete='none'");
          ...
          echo "<div class='first_reciept_div' style='width:100%; font-size:11px;'>
        
        <table class='first_table' style='width:100%; font-size:11px;'> 
        <tr>
<td colspan='6'>
 <table cellspacing='0' style=' width:98%; margin:1%; font-size:11px;'>
<tr>
<td> <img border='0' style='width:100%;'  src='../$fetch_branch_report_logo'></td>    
</tr>
</table>
</td>        
</tr>
          <tr>
            ...
            <tr>
                <td COLSPAN='6' class='fee_recipt_title_name' style='text-align:center; font-size:18px; '><b>Due Fee Slip</b></td>
            </tr>
            <tr>
                <td COLSPAN='6'><div class='horizental_line_black'></div></td>
            </tr>
            ...
            <tr>
                <td><b>Address</b></td>
                <td><b>:</b></td>
                <td colspan='6' style=' vertical-align:top;  '>$final_address_print</td>
            </tr>
            <tr>
                <td></td>
            </tr>
            ...
            <tr>
                <td COLSPAN='6' class='fee_recipt_title_name'><b>Description</b></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan='6'>
             <table cellspacing='0' cellpadding='0' class='fee_group_table' style='font-size:11px;'>
...
$specific_month_explode=implode(",",$old_specific_month_array);  
        if(!empty($get_fee_qty))  
        {
            echo"<tr class='fee_details_heading'>
                ...
                <td style='text-align:center;'>$get_fee_qty</td>
                <td style='text-align:center;'>$specific_month_explode</td>
                <td><div class='div_td'>$get_sub_total_amount</div></td>
                <td><div class='div_td'>$get_fine_amount</div></td>
                <td><div class='div_td'>$get_discount_amount</div></td>
...
$final_payble_due_amount=($due_amount_fine_amount+$fetch_due_amount);
                ...
                <td><div class='div_td'>$fetch_due_amount</div></td>
                <td><div class='div_td'>$due_amount_fine_amount</div></td>
                <td><div class='div_td'>0</div></td>
                 <td><div class='div_td'>".number_format($final_payble_due_amount,2)."</div></td>
                        ...
                        $now_total_payable_fees=($now_total_payable_fees+$total_both_fine_or_due_amount);
                               ...
                               {
                                   echo "<tr><td colspan=6>No Due Fee</td></tr>";   
                               }
...
Dear Parents,
<br/>
Most respectfully, it is stated that an amount of <b><u>$amount_paid_in_word</u></b>,
School fee for the month of till $month_year is pending against school fee of your ward, <b>$student_name</b>.
    We earnestly request you to kindly settle the payment as early as possible so that <b>$student_name</b>
        can smoothly continue his studies at our prestigious institute.
        Also please be informed that we have a policy of accepting fees in installments.
        Your prompt attention in this matter will be highly appreciated.
<br/><br/>
...
<br/>
            ...
            <tr>
                ...
                <td style=' font-size:12px; text-align:right;'><b>Authorized Signatory</b></td>
            </tr>
            ...
            <tr>
                <td COLSPAN='8'><div class='horizental_line_black'></div></td>
            </tr>
            <tr>
                <td colspan='8' style=' text-align:center; height:0px; background-color:whitesmoke;  '> <b>Powered By -  Pixabyte Technologies Pvt. Ltd.</b></td>
            </tr>
            <tr>
                <td COLSPAN='8'><div class='horizental_line_black'></div></td>
            </tr>
