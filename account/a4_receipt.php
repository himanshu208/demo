...
$student_pay_fee_id=$fetch_fee_payment_data['student_pay_fee_id'];
          ...
          echo "<div class='first_reciept_div' >
...
if(!empty($bank_name))
{
           ...
           echo" <tr>
            ...
            <tr>
                <td colspan='2' style=' font-size:14px;'><b>Signature Of Depositor</b></td>
                <td colspan='3'></td>
                <td style=' font-size:14px;'><b>Authorized Signatory</b></td>
            </tr>
            ...
            <tr>
                <td colspan='6' style=' text-align:center; height:30px;  '> <b>Powered By -  Pixabyte Technologies Pvt. Ltd.</b></td>
            </tr>
        </table>
            
        </div> <br/><h1 style='page-break-after:always'></h1>
        ";   
