            ...
            <div id="middel_work_div">
               ...
               value="<?php  echo $fecth_session_id_set;?>">   
                ...
                <div id="top_show_button" style=" border-bottom:1px solid gray; ">
                    <div id="transport_function" class="Short_menu_show"><b>List Of SMS Template</b></div>
                </div>
                 
                
              <div class="middle_left_div_tag">
              <div style=" width:100%; height:10px; "></div>
              <a href="create_sms_template.php">
                  <div class="add_button" style=" background-color:darkgreen; height:30px; float:right; 
                       padding-top:12px;   ">Create Template</div></a> 
                  ...
                  ?>
                      ...
                      <table style=" width:100%; ">
                          <tr>
                            ...
                            <a style="color:blue;" href="#" onclick="window.open('edit_sms_template.php?token_id=<?php  echo $template_encrypt_id;?>','size',config='height=500,width=670,position=absolute,left=300,top=0, addressbar=yes, location=no, toolbar=no, menubar=no,copyhistory=no, scrollbars=yes, resizable=yes, directories=no, status=no');  popup.focus();">  
                        <div class="edit_delete_buttons" style="background-color:green; width:45px;">Edit</div></a>
                                       <div onclick="delete_data('<?php  echo $template_unqiue_id;?>','sms_template_delete_command')" class="edit_delete_button">Delete</div>
