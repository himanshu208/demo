            ...
            <div id="middel_work_div">
                <div class="forward_step_style" style=" float:left; height:40px;  ">
                   <table cellspacing="0" cellpadding="0" class="forward_page_style">
                       <tr>
                           ...
                           <td>/</td>
                           <td>Manage System Generated SMS</td>
                       </tr>
                   </table>   
               </div>
               ...
               value="<?php  echo $fecth_session_id_set;?>">   
                ...
                <div id="top_show_button" style=" border-bottom:1px solid gray; ">
                    <div id="transport_function" class="Short_menu_show"><b>Manage System Generated SMS</b></div>
                </div>
                 ...
                 <table class="small_short_table">
                     <tr>
                      ...
                      <tr>
                        ...
                        <tr>
                            <td><span>Add & View System SMS Group</span></td>
                        </tr>
                 </table>
                </div> 
               </a>
                  ...
                  <a href="manage_system_sms_template.php">
                 <div class="small_dashboard">
                 
                 <table class="small_short_table">
                     <tr>
                         <td>System SMS Template</td>
                     </tr>
                      <tr>
                            <td><div class="small_verticle_line"></div></td>
                        </tr>
                        <tr>
                            <td><span>Add & View System SMS Template</span></td>
                        </tr>
                 </table>
                </div> 
               </a>  
