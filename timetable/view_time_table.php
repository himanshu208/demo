...
<html>
                          ...
                          while ($fetch_course_data=mysql_fetch_array($course_db))
                          {
                           ...
                           }else
                           {
                             echo "<option value='$fetch_course_id'>$fetch_course_name</option>";
                               ...
                               <td><b>:</b></td>
                               <td>
                                   <select id="section_name" onchange="section_ajax(this.value)" class="select_box_time_table">
   ...
   if(empty($fetch_section_id))
   {
    echo "<option>--- Select ---</option>";      
                                ...
                                <td><b>:</b></td>
                                <td><select id="time_table" class="select_box_time_table">
                                        <option value="0">---Select---</option>
...
$time_table=$_REQUEST['Xmlhttptimetable'];
...
while ($time_table_data=mysql_fetch_array($time_table_db))
{
 ...
 if($time_table==$time_table_id)
 {
 echo "<option value='$time_table_id' selected>$time_table_name</option>";
 }else
 {
   echo "<option value='$time_table_id'>$time_table_name</option>";   
                               ...
                               <td>
                                   ...
                                   <input class="button_style_ing" onclick="show_time_table()" type="button" value="Show Time Table">
                   ...
                   <?php
                       if((!empty($_REQUEST['Xmlhtppclass']))&&(!empty($_REQUEST['Xmlhttpsection']))&&(!empty($_REQUEST['Xmlhttptimetable'])))
                       {
                       $class_id=$_REQUEST['Xmlhtppclass'];
                       $section_id=$_REQUEST['Xmlhttpsection'];    
                       $time_table_id=$_REQUEST['Xmlhttptimetable'];
                   $time_table_db=mysql_query("SELECT *,T1.encrypt_id as t1_encrypt_id FROM time_table_db as T1 "
                           ...
                           . " T1.time_table_id='$time_table_id' and T1.class_id='$class_id' "
                     ...
                     $section_name=$time_table_data['section_name'];
                       ...
                       ?>
                        ...
                        <div class="top_button_div">
                            <a href="#" onclick="window.open('print_time_table.php?token_id=<?php echo $encrypt_id;?>','size',config='height=670,width=1200,position=absolute,left=50,top=0, addressbar=yes, location=no, toolbar=no, menubar=no,copyhistory=no, scrollbars=yes, resizable=yes, directories=no, status=no')">
                             <div class="header_top_button" style=" background-color:green; ">Print</div></a>
                   <a href="edit_time_table.php?token_id=<?php echo $encrypt_id;?>&xmlclass=<?php echo $class_id;?>&xmlsection=<?php echo $section_id;?>&xmltimetable=<?php echo $time_table_name;?>"><div class="header_top_button" style=" background-color:dodgerblue; ">Edit</div></a> 
                   <div class="header_top_button" style=" background-color:red; ">Delete</div> 
