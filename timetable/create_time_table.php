...
if(isset($_POST['final_time_table_save']))
{
 ...
 {
$upate_time_db=mysql_query("UPDATE time_table_db SET status='clear',is_delete='none' WHERE time_table_id='$time_table_update_id'");   
 if((!empty($upate_time_db))&&($upate_time_db))
 {
  header("Location:create_time_table.php?status=success");     
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Create/Set Time Table</title>
       ...
       <?php  include_once '../header/header_page.php'; ?>   
        ...
        <div id="main_work_first_div">
            <div id="middel_work_div">
              ...
              <div id="transport_function" class="Short_menu_show"><b>Create/Set Time Table</b></div>
...
?>  
                       ...
                       <tr>
                           ...
                           <tr>
                               ...
                               <td><b>:</b></td>
                               <td>
                                   <select id="class_course_id" name="course_id" onchange="class_id(this.value)" class="select_box_time_table">
  ...
  <input type="text" id="time_table_name" name="time_table_name" class="text_box_time_table"
         placeholder="Please enter time table">
                               ...
                               <td>
                                   ...
                                   <input class="button_style_ing" onclick="continue_button()" type="button" value="Continue">
                   ...
                   $time_table_db=mysql_query("SELECT * FROM time_table_db WHERE $db_main_details encrypt_id='$token_id' and is_delete='yes'");        
 ...
 onclick="edit_subject('<?php echo $week_name;?>','<?php echo $lecture_name;?>','<?php echo $week_db_id;?>','<?php echo $lecture_unqiue_id;?>','<?php echo $start_time;?>','<?php echo $end_time;?>','<?php echo $time_table_update_db_id;?>','<?php echo $subject_id;?>','<?php echo $employee_id;?>','<?php echo $room_no;?>','<?php echo $note;?>')">Edit</div>
                       ...
                       <input type="submit" class="submit_button"  onclick="return final_button_time()" name="final_time_table_save" style=" background-color:dodgerblue; " value="Save">
                       <input type="submit" class="submit_button" name="cancel_time_table" onclick="return cancel_button_time()" style=" background-color:red; "  value="Cancel">
