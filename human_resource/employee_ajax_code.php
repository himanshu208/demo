...
<div id="first_top_div_tags">
       ...
       <div class="button_style" style=" background-color:#4700B2; display:none; ">Print</div></a>
       ...
       <div class="button_style" style="background-color:#3385FF; display:none;">Admission Form Print</div></a>
       
     <div class="button_style" id="employee_account_status" onclick="inactive_account('S15B1AN1','inactive')" style="background-color:#FF5050; display:none;">Account Inactive</div>
       
      
       <div class="button_style" onclick="delete_data('S15B1AN1')" style="background-color:red; display:none;">Delete</div>
       ...
       <div class="button_style" style="background-color:green; display:none;">Edit</div></a>
...
echo"</td>                     
                    ...
                    <td><b>Profession Teaching</b></td><td><b>:</b></td><td>".ucwords($teching_prefession)."</td>
                    </tr>
                    <tr>
                        <td colspan='9'><div class='verticle_lines'></div></td>
                    </tr>
                    ...
                    <tr>
                        <td colspan='9'><span><b>Employee Personal Details</b></span></td>
                    </tr>
                    <tr>
                        <td colspan='9'><div class='verticle_lines'></div></td>
                    </tr>
                    <tr>
                    <td><b>Employee Name</b></td><td><b>:</b></td><td>$employee_full_name</td>
                    ...
                    <td></td><td></td>
                     ...
                     <tr>
                     <td><b>Marital Status</b></td><td><b>:</b></td><td>".ucwords($employee_marital_status)."</td> 
                    <td><b>Employee Mobile No</b></td><td><b>:</b></td><td> $employee_mobile</td>
                    <td><b>Email Id</b></td><td><b>:</b></td><td> $employee_email</td>
                   </tr>
                     
                      <tr>
                        <td colspan='10'><div class='verticle_lines'></div></td>
                    </tr>
                    <tr>
...
if((!empty($user_name)))
{
                    ...
                    <tr>
                        <td colspan='9'><span><b>Account Login Detail</b></span></td>
                    </tr>
                    <tr>
                        <td colspan='9'><div class='verticle_lines'></div></td>
                    </tr>  
                     <tr>
                    <td><b>Username</b></td><td><b>:</b></td><td>$user_name</td>
                    
                    <td><b>Password</b></td><td><b>:</b></td><td>$password</td>
                    </tr>";
}  
...
<td><b>Nearest Area</b></td><td><b>:</b></td><td> $employee_permanent_nearest_area</td>
                    ...
                    <tr>
                        <td colspan='9'><span><b>Emergency Contact Detail</b></span></td>
                    </tr>
                    <tr>
                        <td colspan='9'><div class='verticle_lines'></div></td>
                    </tr>  
                     <tr>
                    <td><b>Mobile No. </b></td><td><b>:</b></td><td>$emergency_mobile_no</td>
                    <td><b>Phone</b></td><td><b>:</b></td><td>$emergency_phone</td>
                    <td><b>Email</b></td><td><b>:</b></td><td>$emergency_email</td>
                    </tr>";
...
<td style='border-right:1px solid black;'>Document</td>
                   ...
                   . "<td style=' border-right:1px solid black;'>";
              {
                  ...
                  {
              ?>
<a href="#" onclick="window.open('../<?php echo $document;?>','size',config='height=500,width=500,position=absolute,left=10,top=0, addressbar=yes, location=no, toolbar=no, menubar=no,copyhistory=no, scrollbars=yes, resizable=yes, directories=no, status=no')">
    <center><input type="button" class="view_button_style" style=" float:none; margin:0 auto;  " value="View Document"></center></a>
             
              <?php
                }else
                {
                    echo "<center><span style='color:red;'>No Document File</span></center>"; 
                }
              }
                    echo"</td>"
                   ."</tr>";
...
echo "</table>
  ...
  if((!empty($achivement_num_rows))||($achivement_num_rows!=0))
 {
      ...
      echo"<tr>
                    ...
                    <tr>
                        <td colspan='9'><span><b>Achievement Detail</b></span></td>
                    </tr>
                     <tr>
                        <td colspan='9'><div class='verticle_lines'></div></td>
                    </tr>
      ...
      while ($achivement_data=mysql_fetch_array($achievemnt_db))
      {
          ...
          . "<td>$achivemnt_title</td>"
                  ...
                  . "<td style='border-right:1px solid black;'>";
              {
                  ...
                  {
              ?>
<a href="#" onclick="window.open('../<?php echo $document_file;?>','size',config='height=500,width=500,position=absolute,left=10,top=0, addressbar=yes, location=no, toolbar=no, menubar=no,copyhistory=no, scrollbars=yes, resizable=yes, directories=no, status=no')">
    <center><input type="button" class="view_button_style" style=" float:none; margin:0 auto;  " value="View Document"></center></a>
      ...
      . "<td style='border-right:1px solid black;'>";
              {
                  ...
                  {
              ?>
<a href="#" onclick="window.open('../<?php echo $e_document_file;?>','size',config='height=500,width=500,position=absolute,left=10,top=0, addressbar=yes, location=no, toolbar=no, menubar=no,copyhistory=no, scrollbars=yes, resizable=yes, directories=no, status=no')">
    <center><input type="button" class="view_button_style" style=" float:none; margin:0 auto;  " value="View Document"></center></a>
