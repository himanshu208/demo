 /form no 1/
          ...
          var class_name=document.getElementById("class_name").value;
           ...
           var admission_no=document.getElementById("student_admission_no").value;
          ...
          if(admission_no==0)
               ...
               return false;
                   ...
                   if(student_sr_no==0)
               {
               alert("Please enter student sr.no");
               return false;
               }else
           if(class_name==0)
               {
      ...
      function form_no_7(no)
     {
         ...
         if(hostel_id==0)
                  ...
                  if(hostel_type_id==0)
             {
                ...
                document.getElementById("hostel_type_id").focus();
                return false;
             }else
                  if(hostel_room_id==0)
             {
